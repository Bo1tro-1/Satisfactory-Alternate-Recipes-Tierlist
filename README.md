...
## 🚀 Live Demo
👉 **[Open Live Visualizer](https://YOUR_GITHUB_USERNAME.github.io/Satisfactory-Alternate-Recipes-Tierlist/)** 
*(Replace with your actual GitHub Pages URL once deployed!)*

---

## 📸 Preview
*(Once you deploy, you can save a screenshot of the app inside the repository as `preview.png` and reference it here)*
```
[ Ingredients ]  ===>  ( Machine / Time )  ===>  [ Products ]
```
...
```bash
git clone https://github.com/YOUR_GITHUB_USERNAME/Satisfactory-Alternate-Recipes-Tierlist.git
...
*   Recipe scores are based on the community alternate recipe analysis ranking spreadsheet.
